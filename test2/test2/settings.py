...
SECRET_KEY = 'mkym*h#rlr8-@pi85+gh-eh65x%2c@sdgl92wg=1%9l^_8$&hg'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root', # 链接数据库的用户名字
        'PASSWORD': 'bbqbbq', # 用户对应的密码
        'HOST': 'localhost', # 指定mysql数据库所在ip
        # 'HOST': '47.107.127.173', # 指定mysql数据库所在ip
        'PORT': 3306, # 端口号
